#!/usr/bin/env bash
# Minimal-circuit GROTH16 proof runner. Off-circuit: derive the level-4 parent node and auto-detect
# the derivation style (Ledger all-hardened m/44'/313'/n'/0' or standard BIP-44 m/44'/313'/n'/0).
...
echo "proving (Groth16, minimal configurable circuit)..."
