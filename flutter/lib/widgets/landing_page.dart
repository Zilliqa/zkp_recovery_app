...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    final paragraphs = [
      ...
      "This application is provided as part of the recovery process. The zero-knowledge proof generated by this application proves that you are the owner of the legacy Schnorr-based wallet; and specifies the new EVM wallet you control, that any existing balance can be transferred to.",
    ].toList();
    return Scaffold(
      appBar: AppBar(
