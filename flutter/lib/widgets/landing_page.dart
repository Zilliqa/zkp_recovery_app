...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    final paragraphs = [
      ...
      "This incident affects only the legacy, non-EVM side of Zilliqa: its accounts, its transactions, and the Zilliqa Ledger application built for it. The newer, EVM-compatible side of Zilliqa is not affected.",
